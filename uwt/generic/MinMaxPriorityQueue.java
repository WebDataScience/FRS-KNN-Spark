...
/*
 * Hasan Asfoor: This is an exact copy of the Google Guava MinMaxPriorityQueue class with only one change in which I force the 
 * class MinMaxPriorityQueue and its inner classes to implement the Serializable interface. 
 * The result of the code (including comments) are taken from the original Guava source code.
 */
/**
...
public final class MinMaxPriorityQueue<E> extends AbstractQueue<E> implements Serializable{
   ...
   */
  private class Heap implements Serializable {
   ...
   * thrown.
   */
  private class QueueIterator implements Iterator<E>, Serializable {
